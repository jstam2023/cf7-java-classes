...
/**
 * Εμφανίζει ένα menu επιλογών (πρόσθεση αφαίρεση κλπ)
 * ο χρήστης επιλέγει
 * Ανάλογα την επιλογη εκτελειτε ανάλογα
 * και εκτυπώνεται το αποτέλεσμα
 * εκτελειται επαναληπτικά μέχρι ο χρήστης
 * να επιλέξει έξοδο
 */
...
public class Calculator {
    ...
    public static void printMenu() {
        ...
        System.out.println("2.Detract");
        System.out.println("3. Multiply");
        System.out.println("4. Divide");
        System.out.println("5. Ypoloipo diaireshs");
