...
public class Account {
     ...
     *              the given ssn
     * @throws Exception
     *      if the ssn is not valid of the balance is not sufficient or the amount is negative
     *
     */
    ...
    public void withdraw(double amount, String ssn) throws SsnNotValidException, InsufficientBalanceException, NegativeAmountException {
        try {
            ...
            balance -= amount;
            System.out.println("Amount " + amount + " successfully withdrown.");
    ...
    /**
     * Returns a string representation of the {@link Account}
